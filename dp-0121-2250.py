...
from PyQt5.QtWidgets import (
    ...
    QFrame, QSystemTrayIcon, QWidget,
)

from PyQt5.QtGui import (
    QColor, QCursor, QFont, QIcon,
    QPainter, QPixmap,
)
...
class myMainWindow(QMainWindow):
    def __init__(self):
        ...
        |Qt.WindowTransparentForInput|Qt.WindowDoesNotAcceptFocus|Qt.SubWindow)#入力すり抜け,フォーカス拒否,タスクバーに非表示
